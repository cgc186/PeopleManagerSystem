...
<html>  
    ...
    <body class="templatemo-bg-image-2">
        <div class="container">
            <div class="col-md-12">			
                <form class="form-horizontal templatemo-contact-form-1" role="form" action="Employees_addServlet?isQuit=${false}" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="templatemo-input-icon-container">
                                <i class="fa fa-pencil-square-o"></i>
                                <input type="text" class="form-control" name="ein_date">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="submit" value="添加职工" class="btn btn-success pull-right">
                        </div>
                    </div>		    	
                </form>		      
            </div>
