                                            ...
                                            <tbody>
                                                <c:forEach items="${Employeeslist}" var="employees">
                                                    <tr class="info">
                                                        ...
                                                        <td>${employees.dno}</td>
                                                        <td>
                                                            <a class="btn btn-info btn-sm" href="Employees_updateServlet?eno=${employees.eno}&isQuit=${true}">更 新</a>
                                                            <a class="btn btn-danger btn-sm" href="Employees_deleServlet?eno=${employees.eno}&isQuit=${true}">删 除</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
                                        <button class="btn btn-success" onclick="window.location.href = 'employees_off_insert.jsp?isQuit=${true}'">添加职工</button>
                                    </div>
                                </div> 
                            </div><!--/widget-body-->
                        </div> <!-- /widget -->
