            ...
            <div class="col-md-12">			
                <form class="form-horizontal templatemo-contact-form-1" role="form" action="#" method="post">
                    <div class="form-group">
                        <div class="col-md-12">
                            <h1 class="margin-bottom-15">更新部门信息</h1>
                        </div>
                    </div>				
                    <div class="form-group">
                        <div class="col-md-12">		          	
                            ...
                            <div class="templatemo-input-icon-container">
                                ...
                                <input type="text" class="form-control" ng-model="dept.dno" readonly="readonly">
                            </div>		            		            		            
                        </div>              
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="button" value="更新部门" class="btn btn-success pull-right" ng-click="cc()">
                        </div>
                    </div>		    	
                </form>		      
            </div>
